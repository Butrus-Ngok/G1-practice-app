...
## Three Test Types:
```
Road Signs Only (20 random from 77)
Rules of the Road (20 random from 104)
Full Practice Test (40 questions - 20 signs + 20 rules)
```
...
Progress Tracking: Visual progress bar and score 
...
Start practicing! - No installation or setup required
...
No Database: All data stored locally in JavaScript files
```
## 🔧 Customization
